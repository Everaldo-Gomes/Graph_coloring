...
Config::Execution_param::Execution_param()
{
    ...
    g_execution_param[0].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[1].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[2].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[3].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[4].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[5].mutate_rate          = MUTATION_RATE;
    ...
    g_execution_param[6].mutate_rate          = MUTATION_RATE;
